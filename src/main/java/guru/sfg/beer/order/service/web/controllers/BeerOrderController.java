...
public class BeerOrderController {
  ...
  public BeerOrderDto placeOrder(
      @PathVariable("customerId") final UUID customerId, @RequestBody final BeerOrderDto beerOrderDto) {
    return beerOrderService.placeOrder(customerId, beerOrderDto);
  }

  @GetMapping("orders/{orderId}")
  public BeerOrderDto getOrder(
      @PathVariable("customerId") final UUID customerId, @PathVariable("orderId") final UUID orderId) {
